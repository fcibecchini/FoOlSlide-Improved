	...
	function sidebar_val()
	{
		...
		$sidebar["series"] = array(
			...
			"content" => array(
				...
				"add_tag" => array("level" => "admin", "name" => _("Add Tag"), "icon" => "pencil"),
				"add_type" => array("level" => "admin", "name" => _("Add Type"), "icon" => "pencil"),
				"manage_tags" => array("level" => "admin", "name" => _("Manage Tags"), "icon" => "archive"),
				"manage_types" => array("level" => "admin", "name" => _("Manage Types"), "icon" => "archive")
			)
		);
		$sidebar["members"] = array(
			"name" => _("Members"),
		...
		$sidebar["preferences"] = array(
			...
			"content" => array(
				...
				"about" => array("level" => "admin", "name" => _("About Page"), "icon" => "info-circle"),
		...
		$sidebar["system"] = array("name" => _("System"),
			...
			"content" => array(
				...
				"upgrade" => array("level" => "admin", "name" => _("Upgrade") . ((get_setting('fs_cron_autoupgrade_version') && version_compare(FOOLSLIDE_VERSION, get_setting('fs_cron_autoupgrade_version')) < 0) ? ' <span class="label success">' . _('New') . '</span>' : ''), "icon" => "cloud-upload"),
			)
		);
