...
<div class="list" id="contact-form">
	...
	<div class="group">
		<div class="elemento" style="color: #000;">
			...
			<?php echo form_open('about#contact-form'); ?>
				<p>
					...
					<?php if ($contact_name_error) : ?><span style="color: #c00;"><?php echo $contact_name_error; ?></span><?php endif; ?>
				</p>
				<p>
					<label for="contact_email" style="color: #000; display: block;"><?php echo _('Email'); ?></label>
					<input type="email" name="contact_email" id="contact_email" value="<?php echo htmlspecialchars($about_contact_form['email']); ?>" required="required" aria-required="true" aria-invalid="<?php echo $contact_email_error ? 'true' : 'false'; ?>" style="width: 100%; max-width: 42rem; border: 1px solid <?php echo $contact_email_error ? '#c00' : '#999'; ?>; color: #000; font: inherit; text-align: left;" />
					<?php if ($contact_email_error) : ?><span style="color: #c00;"><?php echo $contact_email_error; ?></span><?php endif; ?>
				</p>
				<p>
					<label for="contact_subject" style="color: #000; display: block;"><?php echo _('Subject'); ?></label>
					<input type="text" name="contact_subject" id="contact_subject" value="<?php echo htmlspecialchars($about_contact_form['subject']); ?>" required="required" aria-required="true" aria-invalid="<?php echo $contact_subject_error ? 'true' : 'false'; ?>" style="width: 100%; max-width: 42rem; border: 1px solid <?php echo $contact_subject_error ? '#c00' : '#999'; ?>; color: #000; font: inherit; text-align: left;" />
					<?php if ($contact_subject_error) : ?><span style="color: #c00;"><?php echo $contact_subject_error; ?></span><?php endif; ?>
				</p>
				<p>
					<label for="contact_message" style="color: #000; display: block;"><?php echo _('Message'); ?></label>
					<textarea name="contact_message" id="contact_message" rows="8" required="required" aria-required="true" aria-invalid="<?php echo $contact_message_error ? 'true' : 'false'; ?>" style="width: 100%; max-width: 42rem; border: 1px solid <?php echo $contact_message_error ? '#c00' : '#999'; ?>; color: #000; font: inherit; text-align: left;"><?php echo htmlspecialchars($about_contact_form['message']); ?></textarea>
					<?php if ($contact_message_error) : ?><span style="color: #c00;"><?php echo $contact_message_error; ?></span><?php endif; ?>
				</p>
				...
				<p>
					<input type="submit" value="<?php echo _('Send Message'); ?>" style="color: inherit;" />
				</p>
				<?php echo get_notice_toasts('default', 'inline'); ?>
			<?php echo form_close(); ?>
